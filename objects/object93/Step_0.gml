...
if (instance_exists(objPlayer)) {
	...
	//List of changes from 92
	//Black
	//Added random bullets on all trails
	//Replaced lines with repeating shotguns
	...
	*/
	...
	if (gTiming.timer >= 358 && gTiming.timer <= 800)
	{
		...
		if (gTiming.timer == 359 ) {
			repeat(21) funcSBCreationWithin(BBGreen,-random(180),random(5)+5,SBBlack2,objBullet_2);
		}
		...
		if (gTiming.timer == 374 ) {
			repeat(21) funcSBCreationWithin(BBPurple,-random(180),random(5)+5,SBBlack2,objBullet_2);
		}
		...
		if (gTiming.timer > 435 && gTiming.timer < 745 ) {
			if (gTiming.timer % 8 == 0) {
				tempArray[array_size] = funcSBCreationWithin(BBBlue,random(360),1+random(1),SBBlack2,objBullet_Bounce);
				array_size++;
				tempArray[array_size] = funcSBCreationWithin(BBYellow,random(360),1+random(1),SBBlack2,objBullet_Bounce);
				array_size++;
				tempArray[array_size] = funcSBCreationWithin(BBGreen,random(360),1+random(1),SBBlack2,objBullet_Bounce);
				array_size++;
				tempArray[array_size] = funcSBCreationWithin(BBPurple,random(360),1+random(1),SBBlack2,objBullet_Bounce);
				array_size++;
			}
		}
	...
	if (gTiming.timer >= 810 && gTiming.timer <= 1440) {
		...
		if (gTiming.timer == 977) funcCreateCircle(392,296,30,4,objBullet_2,SBYellow2);
		if (gTiming.timer == 998) funcCreateCircle(392,296,30,4,objBullet_2,SBYellow2);
		if (gTiming.timer == 1010) funcCreateCircle(392,296,30,4,objBullet_2,SBYellow2);
		...
		if (gTiming.timer == 1288) { //me nono
			funcCreateCircle(16,16,80,4.5,objBullet_2,SBYellow2);
			funcCreateCircle(784,16,80,4.5,objBullet_2,SBYellow2);
			funcCreateCircle(16,592,80,4.5,objBullet_2,SBYellow2);
			funcCreateCircle(784,592,80,4.5,objBullet_2,SBYellow2);
		}
	...
	if (gTiming.timer == 1460 ) {
		...
		if (gTiming.timer >= 1460 && gTiming.timer < 2000) {
			if (gTiming.timer % 60 == 0) {
				funcSBCreation(144,16,270,5,SBPurple2,objBullet_Waving)
				funcSBCreation(656,16,270,5,SBPurple2,objBullet_Waving)
				funcSBCreation(16,464,0,5,SBPurple2,objBullet_Waving)
				funcSBCreation(784,464,180,5,SBPurple2,objBullet_Waving)
				funcSBCreation(16,144,0,5,SBPurple2,objBullet_Waving)
				funcSBCreation(784,144,180,5,SBPurple2,objBullet_Waving)
				funcSBCreation(656,592,90,5,SBPurple2,objBullet_Waving)
				funcSBCreation(144,592,90,5,SBPurple2,objBullet_Waving)
			}
		...
		if ((gTiming.timer == 1460)) {
			instance_create(BBPurple.x,BBPurple.y,objBulletLine93);
		}
		if (gTiming.timer == 1480 ) {
			instance_create(32,32,objBulletLine93);
			instance_create(32,576,objBulletLine93);
			instance_create(768,576,objBulletLine93);
			instance_create(768,32,objBulletLine93);
		}
		if (gTiming.timer == 1510){
			a = instance_create(BBPurple.x,BBPurple.y,objBulletLine93);
			a.amount = 10;
			a.speed_ = 7;
		}
		if (gTiming.timer == 1560 ) {
			a = instance_create(32,32,objBulletLine93);
			a.amount = 3;
			a.interval = 3;
			a = instance_create(32,576,objBulletLine93);
			a.amount = 3;
			a.interval = 3;
			a = instance_create(768,576,objBulletLine93);
			a.amount = 3;
			a.interval = 3;
			a = instance_create(768,32,objBulletLine93);
			a.amount = 3;
			a.interval = 3;
		}
		...
		if (gTiming.timer == 1675) {
			a = instance_create(16,304,objBulletLine93);
			a.speed_ = 6; 
			a.amount = 7;
			a.interval = 3;
			a = instance_create(784,304,objBulletLine93);
			a.speed_ = 6; 
			a.amount = 7;
			a.interval = 3;
		}
		if (gTiming.timer == 1715) {
			a = instance_create(400,16,objBulletLine93);
			a.speed_ = 6; 
			a.amount = 7;
			a.interval = 3;
			a = instance_create(400,592,objBulletLine93);
			a.speed_ = 6; 
			a.amount = 7;
			a.interval = 3;
	...
	if (gTiming.timer >= 2050 && gTiming.timer <= 2600) {
		...
		if (gTiming.timer == 2060) {
			funcSBShotgunCreationWithin(OBBBlue1,point_direction(OBBBlue1.x,OBBBlue1.y,objPlayer.x,objPlayer.y),6,SBBlue2,objBullet_Curve,15,30,"powerCurve");
			funcSBShotgunCreationWithin(OBBBlue2,point_direction(OBBBlue2.x,OBBBlue2.y,objPlayer.x,objPlayer.y),6,SBBlue2,objBullet_Curve,15,30,"powerCurve");
			funcSBShotgunCreationWithin(OBBBlue3,point_direction(OBBBlue3.x,OBBBlue3.y,objPlayer.x,objPlayer.y),6,SBBlue2,objBullet_Curve,15,30,"powerCurve");
			funcSBShotgunCreationWithin(OBBBlue4,point_direction(OBBBlue4.x,OBBBlue4.y,objPlayer.x,objPlayer.y),6,SBBlue2,objBullet_Curve,15,30,"powerCurve");
		}
		...
		if (gTiming.timer == 2091) {
			funcSBShotgunCreationWithin(OBBBlue1,point_direction(OBBBlue1.x,OBBBlue1.y,objPlayer.x,objPlayer.y),4,SBBlue2,objBullet_Curve,13,30,"powerCurve");
		}
		if (gTiming.timer == 2104) {
			funcSBShotgunCreationWithin(OBBBlue2,point_direction(OBBBlue2.x,OBBBlue2.y,objPlayer.x,objPlayer.y),4,SBBlue2,objBullet_Curve,13,30,"powerCurve");
		}
		if (gTiming.timer == 2116) {
			funcSBShotgunCreationWithin(OBBBlue3,point_direction(OBBBlue3.x,OBBBlue3.y,objPlayer.x,objPlayer.y),4,SBBlue2,objBullet_Curve,13,30,"powerCurve");
		}
		if (gTiming.timer == 2129) {
			funcSBShotgunCreationWithin(OBBBlue4,point_direction(OBBBlue4.x,OBBBlue4.y,objPlayer.x,objPlayer.y),4,SBBlue2,objBullet_Curve,13,30,"linearCurve");
		}
		...
		if (gTiming.timer == 2287) {
			funcSBShotgunCreationWithin(OBBBlue4,point_direction(OBBBlue4.x,OBBBlue4.y,objPlayer.x,objPlayer.y),4,SBBlue2,objBullet_Curve,13,30,"powerCurve");
		}
		...
		if (gTiming.timer == 2356) {
			funcSBShotgunCreationWithin(OBBBlue1,point_direction(OBBBlue1.x,OBBBlue1.y,objPlayer.x,objPlayer.y),3,SBBlue2,objBullet_Curve,10,15,"default");
		}
		...
		if (gTiming.timer == 2402) {
			funcSBShotgunCreationWithin(OBBBlue2,point_direction(OBBBlue2.x,OBBBlue2.y,objPlayer.x,objPlayer.y),3,SBBlue2,objBullet_Curve,10,15,"default");
		}
		...
		if (gTiming.timer == 2437) {
			funcSBShotgunCreationWithin(OBBBlue3,point_direction(OBBBlue3.x,OBBBlue3.y,objPlayer.x,objPlayer.y),3,SBBlue2,objBullet_Curve,10,15,"default");
		}
		...
		if (gTiming.timer == 2521) {
			...
			OBBBlue4.x = 384;
			OBBBlue4.y = 288;
			megaArray = funcSBShotgunCreationWithin(OBBBlue4,point_direction(OBBBlue4.x,OBBBlue4.y,objPlayer.x,objPlayer.y),10,SBBlue2,objBullet_Curve,1000,1,"whoa");
	...
	if (gTiming.timer >= 2623  && gTiming.timer <= 3800) {
		...
		if (gTiming.timer == 3300 || gTiming.timer == 3319 || gTiming.timer == 3342 ||
			...
			tempArray[array_length(tempArray)] = funcCreationWithin(BBGreen,random(360),4,BBGreen2,objSmallBBGreen93,10);
			half++
			if (half == 2) {tempArray[array_length(tempArray)] = funcCreationWithin(BBGreen,random(360),4,BBGreen2,objSmallBBGreen93,10);half = 0}
		}
	...
	if (gTiming.timer > 3800 ){	
		...
		if (gTiming.timer == 3890) {
            Boss93 = instance_create(400, -10, Object93Boss);
            instance_create_depth(0, 0, -1000, Object93BossCounter);
            Boss93.speed = 48;
            Boss93.direction = 270;
            Boss93.image_angle = 360;
        }
		if (gTiming.timer > 3890 and instance_exists(Boss93)) {
	        if (gTiming.timer > 3890 and gTiming.timer <= 3920) {
	            Boss93.speed *= 0.85;
	            Boss93.image_angle *= 0.8;
	        }
	        if (gTiming.timer == 3920) {
	            Boss93.speed = 0;
	            Boss93.y = 304;
	            Boss93.image_angle = 0;
	        }
	        if (gTiming.timer == 6394) {
	            Boss93.invincible = true;
	            Boss93.image_speed = 0;
	        }
	        if (gTiming.timer >= 6650) {
	            Boss93.image_xscale = 1.05;
	            Boss93.image_yscale= 1.05;
	        }
	        if (gTiming.timer == 4540) {
	            Boss93.image_xscale = 3.5 - (3.5 * shrink);
	            Boss93.image_yscale = 3.5 - (3.5 * shrink);
	        }
	        ...
	        if (gTiming.timer == 6231) {
	            Boss93.image_xscale = 3.5 - (3.5 * shrink);
	            Boss93.image_yscale = 3.5 - (3.5 * shrink);
	        }
		}
		if (gTiming.timer == 3923) {
			a = instance_create_depth(8,8,25,objEndingSideBigBullet93);
			a.speed = 8
			a.direction = 0;
			a = instance_create_depth(800-8,608-8,25,objEndingSideBigBullet93);
			a.speed = 8;
			a.direction = 0;
		}
		...
		if (gTiming.timer > 3912) {
			...
			if (gTiming.timer == 3923) {
				a = instance_create(900, 304 ,objEndingWallSide93);
				a.speed = 4;
				a.direction = 270;
				a = instance_create(-100, 304 ,objEndingWall93);
				a.speed = 4;
				a.direction = 90;
			}	
