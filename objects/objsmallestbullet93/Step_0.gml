...
if (gTiming.timer >= 3767 and gTiming.timer <= 3773) { part_particles_create(particleJoe93.partSmallestDashTrailSystem, x, y, particleJoe93.partSmallestDashTrailParticle, 1)}
if (gTiming.timer == 3773) {speed = 1 }
if (gTiming.timer == 3781) {speed = 4 }
if (gTiming.timer >= 3781 and gTiming.timer <= 3792) { part_particles_create(particleJoe93.partSmallestDashTrailSystem, x, y, particleJoe93.partSmallestDashTrailParticle, 1)}
