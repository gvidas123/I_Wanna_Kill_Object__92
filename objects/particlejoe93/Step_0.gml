...
if (instance_exists(objPlayer)) {
	...
	if (gTiming.timer == 203) {
		part_particles_create(partBBBlackAppearParticle, Object93.BBBlue.x, Object93.BBBlue.y, partBBBlackAppearSystem, 20);
	}
	if (gTiming.timer == 218) {
		part_particles_create(partBBBlackAppearParticle, Object93.BBYellow.x, Object93.BBYellow.y, partBBBlackAppearSystem, 20);
	}*/
	/*
	if (gTiming.timer >= 232 && gTiming.timer <= 263) {
		part_particles_create(partBBWobblyTrailSystem, Object93.BBYellow.x, Object93.BBYellow.y, partBBWobblyTrailParticle, 1);
		part_particles_create(partBBWobblyTrailSystem, Object93.BBBlue.x, Object93.BBBlue.y, partBBWobblyTrailParticle, 1);
	}
	...
	if (gTiming.timer > 424 && gTiming.timer < 667) {
		part_particles_create(partBBWobblyTrailSystem, Object93.BBYellow.x, Object93.BBYellow.y, partBBWobblyTrailParticle, 1);
		part_particles_create(partBBWobblyTrailSystem, Object93.BBBlue.x, Object93.BBBlue.y, partBBWobblyTrailParticle, 1);
		part_particles_create(partBBWobblyTrailSystem, Object93.BBPurple.x, Object93.BBPurple.y, partBBWobblyTrailParticle, 1);
		part_particles_create(partBBWobblyTrailSystem, Object93.BBGreen.x, Object93.BBGreen.y, partBBWobblyTrailParticle, 1);
	}
	if (gTiming.timer >= 667 && gTiming.timer < 750) {
		part_particles_create(partBBWobblierTrailSystem, Object93.BBYellow.x, Object93.BBYellow.y, partBBWobblierTrailParticle, 1);
		part_particles_create(partBBWobblierTrailSystem, Object93.BBBlue.x, Object93.BBBlue.y, partBBWobblierTrailParticle, 1);
		part_particles_create(partBBWobblierTrailSystem, Object93.BBPurple.x, Object93.BBPurple.y, partBBWobblierTrailParticle, 1);
		part_particles_create(partBBWobblierTrailSystem, Object93.BBGreen.x, Object93.BBGreen.y, partBBWobblierTrailParticle, 1);
	}*/
	...
	if (gTiming.timer == 359) {
		part_particles_create(partBBBlackAppearParticle, Object93.BBGreen.x, Object93.BBGreen.y, partBBBlackAppearSystem, 20);
	}
	if (gTiming.timer == 374) {
		part_particles_create(partBBBlackAppearParticle, Object93.BBPurple.x, Object93.BBPurple.y, partBBBlackAppearSystem, 20);
	}*/
	...
	*/
	if (gTiming.timer == 743) {
		var SBArray = Object93.tempArray;
		var arrr = Object93.array_size;
		var i = 0;
		repeat(arrr/3) {
...
if (gTiming.timer >= 3767 && gTiming.timer <= 3800) {
	...
	var i = 0;
	repeat(array_length(Object93.tempArray)) {
		part_particles_create(partSmallestDashTrailSystem, Object93.tempArray[i].x, Object93.tempArray[i].y, partSmallestDashTrailParticle, 1);
		i++;
	}
}*/
